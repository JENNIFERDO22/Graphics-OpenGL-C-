...
void Sprite::spriteModeOn(int winx, int winy)
{
		...
		static int call_count=0; // number of calls
...
void Sprite::text(int x, int y, char *string)
{
  ...
  glColor4f( 1.0f, (69.0/255.0), 0.0f, 1.0f );  // Orange
...
// change xpos and ypos to change initial position
// setup everything and then load the image
...
void Sprite::advance_projectile()
{
	...
	float g=0.1;    // acceleration due to gravity
